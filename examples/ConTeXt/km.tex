...
$ mkdir km-test
$ cd km-test
$ wget http://192.168.0.7:8080/meta-doc/agn_km.orz -O agn_km.orz
...
wget $LOCATION/meta-doc/agn_m4_macros.orz -O agn_m4_macros.orz
orez -t -s "," -e "agn_m4_macros.m4, agn-m4.sh" agn_m4_macros.orz
sed -i '/[[:blank:]]*#line.*/d' ./agn-m4.sh
chmod +x agn-m4.sh

wget $LOCATION/meta-doc/agn_point.orz -O agn_point.orz
for i in h c ; do ./agn-m4.sh agn_point.orz agn_point.${i}_T ; done
